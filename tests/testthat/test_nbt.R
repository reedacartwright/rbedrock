...
rawval_args <- list(
  list(b = 1L, "pos", b = 100, b = 1L, "neg", b = 254),
  list(b = 2L, "pos", s = 100, b = 2L, "neg", s = -2),
  list(b = 3L, "pos", i = 100, b = 3L, "neg", i = -2),
  list(
    b = 4L,
    "pos",
  ...
  list(b = 5L, "pos", f = 36.125, b = 5L, "neg", f = -1776.75),
  list(b = 6L, "pos", d = 36.125, b = 6L, "neg", d = -1776.75),
  list(b = 7L, "8val", 8L, b = 10:17, b = 7L, "1val", 1L, b = 20),
  list(
    b = 8L,
    "test",
    "hello world",
  ...
  list(b = 11L, "8val", 8L, i = 10:17, b = 11L, "1val", 1L, i = 20),
  list(b = 12L, "8val", 8L, l = 10:17, b = 12L, "1val", 1L, l = 20),
  list(b = 10L, "test", b = 1L, "a", b = 1, b = 3L, "b", i = 2, b = 0L),
  list(b = 9L, "empty", b = 0L, 0L),
  list(b = 9L, "a", b = 1L, 2L, b = 1:2, b = 9L, "b", b = 1L, 1L, b = -3),
  list(b = 9L, "a", b = 2L, 2L, s = 1:2, b = 9L, "b", b = 2L, 1L, s = -3),
  list(b = 9L, "a", b = 3L, 2L, i = 1:2, b = 9L, "b", b = 3L, 1L, i = -3),
  list(b = 9L, "a", b = 4L, 2L, l = 1:2, b = 9L, "b", b = 4L, 1L, l = -3),
  list(b = 9L, "a", b = 5L, 2L, f = 1:2, b = 9L, "b", b = 5L, 1L, f = -3),
  list(b = 9L, "a", b = 6L, 2L, d = 1:2, b = 9L, "b", b = 6L, 1L, d = -3),
  list(b = 9L, "a", b = 7L, 2L, 2, b = 1:2, 1, b = -3),
  list(
    b = 9,
    "abc",
    b = 8,
  ...
  list(b = 9L, "a", b = 11L, 2L, 2, i = 1:2, 1, i = -3),
  list(b = 9L, "a", b = 12L, 2L, 2, l = 1:2, 1, l = -3),
  list(
    b = 9,
    "cmplst",
    b = 10,
  ...
  list(b = 9, "lstlst", b = 9, 2, b = 1, 1, b = 1, b = 2, 2, s = -1:0)
)
