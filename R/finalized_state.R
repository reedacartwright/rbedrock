...
#' data from `db`. `get_finalized_state_data()` will silently drop and keys not
#' representing FinalizedState data. `get_finalized_state_value()` supports loading
#' only a single value. `get_finalized_state_values()` is a synonym for 
